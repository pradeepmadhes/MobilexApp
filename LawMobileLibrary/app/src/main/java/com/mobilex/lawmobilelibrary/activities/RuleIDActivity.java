...
public class RuleIDActivity extends Activity 
{
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        {    
            ...
            public void run()
            {   
                indexLast = CommonVariables.MAP_KEY_SNO_RULE.size() - 1;
        ...
        {            
            ...
            else
            {
                ...
                if(CommonVariables.MAP_KEY_ID_RULE.containsKey(edbChrs))
                {
                    ...
                    String strHead  = CommonVariables.LIST_RULE_VALUES.get(inpIndex);
                    String strBody  = CommonVariables.LIST_RULE_CONTENT.get(inpIndex);
    ...
    private class InputButtons implements OnClickListener
    {
        public void onClick(View v) 
        {
            ...
            strIndex   = CommonVariables.MAP_KEY_ID_RULE.get(strCurrent);    
            ...
            switch(v.getId())
            {
                case R.id.btn_prev:
                                    ...
                                    strId    = CommonVariables.MAP_KEY_SNO_RULE.get(strSno);
