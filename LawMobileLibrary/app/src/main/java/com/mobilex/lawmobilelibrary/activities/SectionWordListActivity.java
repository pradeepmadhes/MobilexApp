...
public class SectionWordListActivity extends TabActivity
{    
    ...
    private Handler handler = new Handler()
    {
        ...
        public void handleMessage(Message msg)
        {
            ...
            {            
                ...
                intent = new Intent().setClass(getApplicationContext(), SectionListActivity.class);
                spec = tabHost.newTabSpec("Search by Section").setIndicator("Search by Section").setContent(intent);
                tabHost.addTab(spec);

                intent = new Intent().setClass(getApplicationContext(), SectionWordActivity.class);
