...
public class IndexIDActivity extends Activity 
{
    int indexStart = 0, indexLast = 1;
    
    private String selectedLabel = "", strHead = "", strBody = "";
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        {    
            ...
            public void run()
            {
                indexLast = CommonVariables.TEMP_KEY_SNO.size() - 1;
    ...
    private class InputEditText implements TextWatcher
    {
        ...
        {            
            ...
            else
            {
                ...
                if(CommonVariables.TEMP_KEY_ID.containsKey(edbChrs))
                {
                    String strIndex = CommonVariables.TEMP_KEY_ID.get(edbChrs);
                    int    inpIndex = Integer.parseInt(strIndex) - 1;
                    String strHead  = CommonVariables.LIST_TEMP_VALUES.get(inpIndex);
                    String strBody  = CommonVariables.LIST_TEMP_CONTENT.get(inpIndex);
    ...
    private class InputButtons implements OnClickListener
    {
        public void onClick(View v) 
        {
            ...
            strIndex   = CommonVariables.TEMP_KEY_ID.get(strCurrent);    
            ...
            switch(v.getId())
            {
                case R.id.btn_prev:
                                    ...
                                    strId    = CommonVariables.TEMP_KEY_SNO.get(strSno);
